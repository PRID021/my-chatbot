    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gray-100 dark:bg-gray-900 p-4 sm:p-8 lg:p-16">
      ...
      >
        <div className="flex flex-col items-center text-center w-full md:items-center md:text-left md:w-1/2">
          ...
          <h4 className="text-sm text-gray-600 dark:text-gray-400 mb-6 font-bold self-start">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2 lg:mb-12 text-center self-center">
